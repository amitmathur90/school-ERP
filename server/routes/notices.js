...
router.post("/", authenticate, authorizeRoles("super_admin", "admin", "hod", "faculty"), async (req, res) => {
...
router.delete("/:id", authenticate, authorizeRoles("super_admin", "admin", "hod", "faculty"), async (req, res) => {
