                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _Section(title: 'Personal', rows: {
                      ...
                      if (admission.maritalStatus?.toLowerCase() == 'married') "Spouse's Name": admission.spouseName,
                      if (admission.maritalStatus?.toLowerCase() == 'married') "Spouse's Phone": admission.spousePhone,
                      ...
                      'How did you know about SPVM?': admission.howKnow,
                    }),
                    ...
                    _Section(title: 'Course Applied For', rows: {
                      'Course Group': admission.courseGroup,
                      'Course': course?.name,
